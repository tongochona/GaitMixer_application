...
def parse_option():
    ...
    parser.add_argument("dataset", choices=["casia-b-query", "casia-b", "OUMVLP", "YOLO"])
    parser.add_argument("--train_data_path", help="Path to train data CSV")
    parser.add_argument("--predict_data_path", help="Path to predict image")
    parser.add_argument("--ref_data_path", help="Path to reference data CSV")
